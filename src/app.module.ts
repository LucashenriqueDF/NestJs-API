...
import { UpdateService } from './services/update-service/update-service.service';
import { GetService } from './services/get-service/get-service.service';
import { DeleteService } from './services/delete-service/delete-service.service';

@Module({
  imports: [],
  controllers: [AppController, PostController, GetController, UpadateController, DeleteController],
  providers: [AppService, PostService, UpdateService, GetService, DeleteService],
})
